    ...
    return (
        <div>
            ...
            <p>
                ...
                Our chefs are passionate about creating dishes that are both flavorful and visually stunning. We use only the freshest, highest quality ingredients in all of our recipes. Whether you're in the mood for a juicy steak, a fresh salad, or a decadent dessert, we have something to please every palate.
                <br/><br/>
